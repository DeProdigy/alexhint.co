module ApplicationHelper
  ...
  def resume_link
    link_to image_tag('briefcase.png', class: 'animated fadeInUp icon'), 'https://drive.google.com/file/d/0B87BKNuErC3qOEJkSnQzVFNKT28/view?usp=sharing', class: 'link', target: 'blank'
  end
